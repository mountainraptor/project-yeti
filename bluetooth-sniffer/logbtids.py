...
class lapDb(object):
   def __init__(self, dBFile):
      ...
      try:
         ...
         self.cursor.execute('CREATE TABLE lapTable(lap INT NOT NULL, epoch INT NOT NULL, errors INT NOT NULL, count INT NOT NULL, duration INT NOT NULL, snr INT NOT NULL)')
         self.conn.commit()
